...
/**
 * 회신 요약 호출 응답 — 화면 표시 + 작성 회송용 (PM 재설계 v0.58, 요약 프롬프트 갱신본 2026-07).
 *
 * <p>메일 2건 이상 + 요약 성공 시 FE 가 이 {@code summary_lines} 를 작성 요청에 그대로 회송하면
 * 작성·점검이 원문 대신 요약을 대화 입력으로 사용한다(속도 개선, PM 확정). 미회송이면 원문 fallback.
 *
